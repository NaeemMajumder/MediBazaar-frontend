...
const Dashboard = () => {
  return (
    <div className="flex flex-col md:flex-row min-h-screen">
      {/* Sidebar */}
      <aside className="bg-[#2facb7] lg:w-1/4 md:h-screen h-auto flex md:flex-col flex-row items-center justify-between md:justify-start md:gap-8 gap-0 md:p-8 p-4 fixed bottom-0 left-0 w-full md:relative shadow-xl border-t-4  border-[#1ca288] z-50">
      ...
      >
        ...
        <span className="hidden md:inline text-lg font-semibold">Cart Items</span>
      </NavLink>
      ...
      >
        ...
        <span className="hidden md:inline text-lg font-semibold">Payment History</span>
      </NavLink>
      ...
      >
        ...
        <span className="hidden md:inline text-lg font-semibold">Pay Now</span>
      </NavLink>
