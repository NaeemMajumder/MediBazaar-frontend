...
const Shop = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Shop | MediBazaar</title>
      </Helmet>
      <div className="container max-w-[1350px] mx-auto p-4">
        <h1 className="text-3xl font-bold text-center text-[#164193] my-6">
          Shop Medicines
        </h1>
                ...
                <tr key={medicine._id} className="border-b hover:bg-gray-100">
                  ...
                  <td className="p-4 border flex gap-2">
                    ...
                    <button
                      ...
                      className="bg-[#3AB092] text-white px-4 py-2 rounded"
                    >
                      ➕ Select
                    </button>
                  </td>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="bg-white p-6 rounded-lg shadow-lg max-w-lg h-[60vh] overflow-auto w-full">
              ...
              <p className="text-gray-700">
                ...
                {selectedMedicine.original_price}
              </p>
              ...
              <p className="text-gray-500 mt-2">
                <strong>Seller:</strong> {selectedMedicine.userName} (
                {selectedMedicine.userEmail})
              </p>
              <button
